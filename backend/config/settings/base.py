...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "sk_tech"),
        "USER": os.environ.get("DB_USER", "sk_tech"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "sk_tech"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        "apps.core.permissions.DynamicRBACPermission",
    ),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "SK Tech API",
    "DESCRIPTION": "Enterprise AI-Powered Multi-Tenant SaaS Platform",
    "VERSION": "1.0.0",
